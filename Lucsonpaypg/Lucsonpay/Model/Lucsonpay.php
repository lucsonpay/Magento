...
use Lucsonpaypg\Lucsonpay\Helper\Data as DataHelper;

class Lucsonpay extends \Magento\Payment\Model\Method\AbstractMethod
{
    const CODE = 'lucsonpay';
    ...
    protected $_formBlockType = 'Lucsonpaypg\Lucsonpay\Block\Form\Lucsonpay';
    protected $_infoBlockType = 'Lucsonpaypg\Lucsonpay\Block\Info\Lucsonpay';
    ...
    public function __construct(
        ...
        \Lucsonpaypg\Lucsonpay\Helper\Data $helper
    ) {
        $this->helper = $helper;
        parent::__construct(
            $context,
    ...
    public function buildLucsonpayRequest($order)
    {
        $callBackUrl=$this->urlBuilder->getUrl('lucsonpay/Standard/Response', ['_secure' => true]);
    ...
    $post_group_data['TXNTYPE']='SALE';
      $post_group_data['HASH']="$hash";
        if(isset($order->lucsonpayPromoCode)){
            $params['PROMO_CAMP_ID']=$order->lucsonpayPromoCode;
        }
